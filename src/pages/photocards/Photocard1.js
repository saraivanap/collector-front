  ...
  return (
    <div className="flex flex-col items-center p-4 bg-white min-h-screen">
      <div className="flex flex-col md:flex-row items-center bg-white rounded-lg  p-4">
        <img src={photocard1} alt="S.Coups" className="w-full md:w-auto h-80 object-cover rounded-lg" />
        <div className="md:ml-8 mt-4 md:mt-0">
          <h1 className="text-4xl font-bold text-gray-500 mb-8">S.Coups - Choi Seung Cheol (최승철)</h1>
          <p className="text-lg">
            Choi Seung Cheol, known by his stage name S.Coups, is the leader of the South Korean boy group Seventeen under Pledis Entertainment. He is a rapper and is part of the Hip-Hop unit in the group.
          </p>
          <p className="mt-4 text-lg">
            <strong>Birthday:</strong> August 8, 1995<br/>
            <strong>Position:</strong> Leader, Main Rapper, Sub Vocalist<br/>
