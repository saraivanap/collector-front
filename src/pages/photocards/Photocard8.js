  ...
  return (
    <div className="flex flex-col items-center p-4 bg-white min-h-screen">
      <div className="flex flex-col md:flex-row items-center bg-white rounded-lg p-4">
        <img src={photocard8} alt="DK" className="w-full md:w-auto h-80 object-cover rounded-lg" />
        <div className="md:ml-8 mt-4 md:mt-0">
          <h1 className="text-4xl font-bold text-gray-500 mb-8">DK - Lee Seokmin (이석민)</h1>
          <p className="text-lg">
            Lee Seokmin, known by his stage name DK, is a member of the South Korean boy group Seventeen under Pledis Entertainment. He is a main vocalist and part of the Vocal unit in the group.
          </p>
          <p className="mt-4 text-lg">
            <strong>Birthday:</strong> February 18, 1997<br/>
