  ...
  return (
    <div className="flex flex-col items-center p-4 bg-white min-h-screen">
      <div className="flex flex-col md:flex-row items-center bg-white rounded-lg p-4">
        <img src={photocard9} alt="Mingyu" className="w-full md:w-auto h-80 object-cover rounded-lg" />
        <div className="md:ml-8 mt-4 md:mt-0">
          <h1 className="text-4xl font-bold text-gray-500 mb-8">Mingyu - Kim Mingyu (김민규)</h1>
          <p className="text-lg">
            Kim Mingyu, known by his stage name Mingyu, is a member of the South Korean boy group Seventeen under Pledis Entertainment. He is a rapper and part of the Hip-Hop unit in the group.
          </p>
          <p className="mt-4 text-lg">
            <strong>Birthday:</strong> April 6, 1997<br/>
            <strong>Position:</strong> Lead Rapper, Face of the Group<br/>
