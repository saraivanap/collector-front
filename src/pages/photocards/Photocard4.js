  ...
  return (
    <div className="flex flex-col items-center p-4 bg-white min-h-screen">
      <div className="flex flex-col md:flex-row items-center bg-white rounded-lg p-4">
        <img src={photocard4} alt="Jun" className="w-full md:w-auto h-80 object-cover rounded-lg" />
        <div className="md:ml-8 mt-4 md:mt-0">
          <h1 className="text-4xl font-bold text-gray-500 mb-8">Jun - Wen Junhui (文俊辉)</h1>
          <p className="text-lg">
            Wen Junhui, known by his stage name Jun, is a member of the South Korean boy group Seventeen under Pledis Entertainment. He is a part of the Performance unit in the group.
          </p>
