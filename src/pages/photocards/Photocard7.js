  ...
  return (
    <div className="flex flex-col items-center p-4 bg-white min-h-screen">
      <div className="flex flex-col md:flex-row items-center bg-white rounded-lg p-4">
        <img src={photocard7} alt="Woozi" className="w-full md:w-auto h-80 object-cover rounded-lg" />
        <div className="md:ml-8 mt-4 md:mt-0">
          <h1 className="text-4xl font-bold text-gray-500 mb-8">Woozi - Lee Jihoon (이지훈)</h1>
          <p className="text-lg">
            Lee Jihoon, known by his stage name Woozi, is a member of the South Korean boy group Seventeen under Pledis Entertainment. He is the leader of the Vocal unit in the group and is known for his songwriting and producing skills.
          </p>
          <p className="mt-4 text-lg">
            <strong>Birthday:</strong> November 22, 1996<br/>
            <strong>Position:</strong> Vocal Unit Leader, Lead Vocalist<br/>
            <strong>Nationality:</strong> South Korean
          </p>
        </div>
      </div>
