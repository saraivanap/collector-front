  ...
  return (
    <div className="flex flex-col items-center p-4 bg-white min-h-screen">
      <div className="flex flex-col md:flex-row items-center bg-white rounded-lg p-4">
        <img src={photocard13} alt="Dino" className="w-full md:w-auto h-80 object-cover rounded-lg" />
        <div className="md:ml-8 mt-4 md:mt-0">
          <h1 className="text-4xl font-bold text-gray-500 mb-8">Dino - Lee Chan (이찬)</h1>
          <p className="text-lg">
            Lee Chan, known by his stage name Dino, is a member of the South Korean boy group Seventeen under Pledis Entertainment. He is a dancer and is part of the Performance unit in the group.
          </p>
          <p className="mt-4 text-lg">
            <strong>Birthday:</strong> February 11, 1999<br/>
            <strong>Position:</strong> Main Dancer, Lead Rapper, Sub Vocalist, Maknae<br/>
