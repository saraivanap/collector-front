  ...
  return (
    <div className="flex flex-col items-center p-4 bg-white min-h-screen">
      <div className="flex flex-col md:flex-row items-center bg-white rounded-lg p-4">
        <img src={photocard3} alt="Joshua" className="w-full md:w-auto h-80 object-cover rounded-lg" />
        <div className="md:ml-8 mt-4 md:mt-0">
          <h1 className="text-4xl font-bold text-gray-500 mb-8">Joshua - Hong Jisoo (홍지수)</h1>
          <p className="text-lg">
            Hong Jisoo, known by his stage name Joshua, is a member of the South Korean boy group Seventeen under Pledis Entertainment. He is a vocalist in the group.
          </p>
          <p className="mt-4 text-lg">
            <strong>Birthday:</strong> December 30, 1995<br/>
            <strong>Position:</strong> Lead Vocalist<br/>
