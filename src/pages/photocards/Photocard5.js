  ...
  return (
    <div className="flex flex-col items-center p-4 bg-white min-h-screen">
      <div className="flex flex-col md:flex-row items-center bg-white rounded-lg p-4">
        <img src={photocard5} alt="Hoshi" className="w-full md:w-auto h-80 object-cover rounded-lg" />
        <div className="md:ml-8 mt-4 md:mt-0">
          <h1 className="text-4xl font-bold text-gray-500 mb-8">Hoshi - Kwon Soon Young (권순영)</h1>
          <p className="text-lg">
            Kwon Soon Young, known by his stage name Hoshi, is a member of the South Korean boy group Seventeen under Pledis Entertainment. He is the leader of the Performance unit in the group.
          </p>
          <p className="mt-4 text-lg">
            <strong>Birthday:</strong> June 15, 1996<br/>
            <strong>Position:</strong> Leader of Performance Unit, Main Dancer, Lead Vocalist<br/>
